...
<div align="center">
  ...
  <h3><b>Crypto Currency Market Indicator</b></h3>
...
# 📖 Crypto Currency Market Indicator <a name="about-project"></a>
...
- **Display Various Crypto Coins**
- **Detailed description of individial currency**
- **Search input**
...
```sh
  ...
  git clone https://github.com/tsheporamantso/crypto-market.git
```
...
Feel free to check the [issues page](https://github.com/tsheporamantso/crypto-market/issues).
